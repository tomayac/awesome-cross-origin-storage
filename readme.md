...
- [Cross-Origin Storage Extension (Firefox)](https://github.com/web-ai-community/cross-origin-storage-extension) - Browser extension that polyfills the proposed API by injecting `navigator.crossOriginStorage.requestFileHandle()` into every page. Same source as the Chrome extension above; not yet published to addons.mozilla.org.
